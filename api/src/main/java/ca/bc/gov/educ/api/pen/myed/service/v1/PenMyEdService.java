...
public class PenMyEdService {
  ...
  public Mono<ResponseEntity<PenRequestBatchSubmissionResult>> getBatchSubmissionResult(UUID batchSubmissionID) {
    return this.restUtils.findBatchSubmissionResult(batchSubmissionID.toString());
  }

  public Mono<ResponseEntity<PenCoordinator>> getPenCoordinatorByMinCode(String mincode){
